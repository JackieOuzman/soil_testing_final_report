...
### I have done something wrong in the next section
...
table2_2019_P <- table2_2019_P %>% 
  rename(detail = soil_test_says_P, 
         count= count_vs_GSP) %>% 
  mutate(count_zones = 65,
         percent = (count /65)*100)
...
# rec_rate_vs_GSP_2020_P %>%  group_by(GSP) %>% 
#   summarise(count = n()) #106 with GSP
...
# rec_rate_vs_GSP_2020_N %>%  group_by(GSP) %>% 
#   summarise(count = n()) #72 with GSP
...
table1_2020_N <- table1_2020_N %>% 
  rename(detail = yld_repsonse_likely_to_n, 
         count= count_n_over0)%>% 
  mutate(count_zones = 73,
         percent = (count /73)*100)

table2_2020_N <- table2_2020_N %>% 
  rename(detail = soil_test_says_N, 
         count= count_vs_GSP)%>% 
  mutate(count_zones = 72,
         percent = (count /72)*100)
